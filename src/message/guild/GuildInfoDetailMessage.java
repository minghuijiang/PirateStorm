...
public class GuildInfoDetailMessage extends Message{

	public static final int id = 1202;
	public int guildId;
	...
	public int xpCurrLevel;
	public int xpNextLevel;

	public GuildInfoDetailMessage(User user) {
		super(user);
	}
	...
	public void deserialize(ByteArray data){
		...
		this.xpCurrLevel = data.readInt();
		this.xpNextLevel = data.readInt();
	}
	...
	public void serialize(ByteArray data){
		...
		data.writeInt(this.xpCurrLevel);
		data.writeInt(this.xpNextLevel);
	}
	...
	public Message getInstance(User user) {
		return new GuildInfoDetailMessage(user);
	}
...
//
//    public class ASV2014_762 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1202;
//
...
//        private var ASV2014_5950:int;
//        private var ASV2014_5951:int;
//
//        public function ASV2014_762()
//        {
//            this.founderName = "";
//            this.leaderName = "";
//            this.guildText = "";
...
//            this.ASV2014_5950 = _arg1.readInt();
//            this.ASV2014_5951 = _arg1.readInt();
//        }
//
...
//            _arg1.writeInt(this.ASV2014_5950);
//            _arg1.writeInt(this.ASV2014_5951);
//        }
//
...
//        }
//
//        public function get xpCurrLevel():int
//        {
//            return (this.ASV2014_5950);
//        }
//
//        public function set xpCurrLevel(_arg1:int):void
//        {
//            this.ASV2014_5950 = _arg1;
//        }
//
//        public function get xpNextLevel():int
//        {
//            return (this.ASV2014_5951);
//        }
//
//        public function set xpNextLevel(_arg1:int):void
//        {
//            this.ASV2014_5951 = _arg1;
//        }
//
...
// ASV2014_5950 = "&9" (String#18138)
// ASV2014_5951 = "\"!4" (String#16931)
// ASV2014_762 = "^w" (String#5839)
//