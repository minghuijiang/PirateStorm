...
public class GuildMemberListRequestMessage extends Message{

	public static final int id = 1210;
	public int ASV2014_2747;

	public GuildMemberListRequestMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildMemberListRequestMessage(user);
	}
...
//
//    public class ASV2014_836 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1210;
//
