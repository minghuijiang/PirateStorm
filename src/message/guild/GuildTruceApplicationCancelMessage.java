...
public class GuildTruceApplicationCancelMessage extends Message{

	public static final int id = 1283;
	public int targetGuildId;

	public GuildTruceApplicationCancelMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildTruceApplicationCancelMessage(user);
	}
...
//
//    public class ASV2014_846 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1283;
//
