...
public class GuildBlackboardDeleteMessage extends Message{

	public static final int id = 1233;
	public int ASV2014_2861;

	public GuildBlackboardDeleteMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildBlackboardDeleteMessage(user);
	}
...
//
//    public class ASV2014_873 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1233;
//
