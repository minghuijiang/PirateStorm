...
public class GuildIslandConstructionListRequestMessage extends Message{

	public static final int id = 1296;
	public int constructionType;

	public GuildIslandConstructionListRequestMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildIslandConstructionListRequestMessage(user);
	}
...
//
//    public class ASV2014_1471 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1296;
//
