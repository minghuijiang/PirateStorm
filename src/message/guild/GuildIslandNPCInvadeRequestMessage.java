...
public class GuildIslandNPCInvadeRequestMessage extends Message{

	public static final int id = 1272;
	public int ASV2014_3361;

	public GuildIslandNPCInvadeRequestMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildIslandNPCInvadeRequestMessage(user);
	}
...
//
//    public class ASV2014_870 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1272;
//
