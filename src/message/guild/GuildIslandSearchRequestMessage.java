...
public class GuildIslandSearchRequestMessage extends Message{

	public static final int id = 1260;
	public int _category;
	public String _name;
	public int _type;
	public int ASV2014_2747;

	public GuildIslandSearchRequestMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildIslandSearchRequestMessage(user);
	}
...
//
//    public class ASV2014_857 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1260;
//
