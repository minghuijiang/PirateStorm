...
public class GuildApplicationCancelMessage extends Message{

	public static final int id = 1223;
	public int guildId;

	public GuildApplicationCancelMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new GuildApplicationCancelMessage(user);
	}
...
//
//    public class ASV2014_859 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1223;
//
