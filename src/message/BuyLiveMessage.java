...
public class BuyLiveMessage extends Message{

	public static final int id = 1176;
	public int bonusMapId;

	public BuyLiveMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new BuyLiveMessage(user);
	}
...
//
//    public class ASV2014_183 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1176;
//
