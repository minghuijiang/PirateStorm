...
public class QuestProgressUpdateMessage extends Message{

	public static final int id = 1144;
	public int questId;
	public int _status;

	public QuestProgressUpdateMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new QuestProgressUpdateMessage(user);
	}
...
//
//    public class ASV2014_1095 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1144;
//
