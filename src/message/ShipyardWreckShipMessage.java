...
public class ShipyardWreckShipMessage extends Message{

	public static final int id = 1188;
	public int shipStockId;

	public ShipyardWreckShipMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new ShipyardWreckShipMessage(user);
	}
...
//
//    public class ASV2014_1527 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1188;
//
