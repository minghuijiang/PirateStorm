...
public class ItemInfo extends Message{
	...
	public ItemInfo(User user) {
		super(user);
	}
	public ItemInfo(User user, int type, int id, int level, int amount) {
		this(user);
		itemType= type;
		itemDefaultId = id;
		itemLevel= level;
...
//
//    public class ASV2014_61 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1006;
//
