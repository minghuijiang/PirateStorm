...
public class DoBidMessage extends Message{

	public static final int id = 1457;
	public int itemID;

	public DoBidMessage(User user) {
		super(user);
	}
	
	public DoBidMessage(User user, int item) {
		this(user);
		itemID = item;
		user.log("Bid on: "+itemID);
	}
...
//
//    public class ASV2014_643 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1457;
//
