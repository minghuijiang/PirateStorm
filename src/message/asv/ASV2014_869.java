...
public class ASV2014_869 extends Message{

	public static final int id = 1294;
	public int memberCount;
	public int _pageIndex;
	public int ASV2014_5178;
	public MessageList _result;

	public ASV2014_869(User user) {
		super(user);
		_result = new MessageList(user);
	}

	public void deserialize(ByteArray data){
		this.memberCount = data.readByte();
	...
	public void serialize(ByteArray data){
		data.writeByte(this.memberCount);
...
//
//    public class ASV2014_869 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1294;
//
...
//        {
//            this.ASV2014_5948 = _arg1.readByte();
...
//        {
//            _arg1.writeByte(this.ASV2014_5948);
