...
public class StartTechMessage extends Message{

	public static final int id = 1605;
	public int ASV2014_4344;

	public StartTechMessage(User user) {
		super(user);
	}

	public StartTechMessage(User user,int id) {
		this(user);
		ASV2014_4344=id;
	}
	...
	public Message getInstance(User user) {
		return new StartTechMessage(user);
	}
...
//
//    public class ASV2014_1506 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1605;
//
