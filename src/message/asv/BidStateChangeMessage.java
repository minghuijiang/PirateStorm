...
public class BidStateChangeMessage extends Message{

	public static final int id = 1455;
	public int itemID;
	...
	public BidStateChangeMessage(User user) {
		super(user);
	}
	...
	public void serialize(ByteArray data){
		...
		data.writeInt(this.bidderID);
		data.writeUTF(this.bidderName);
		data.writeInt(this._timeLeft);
	}

	public void action(){
		System.out.println("receive bid");
		if(bidderID!=user.userId)
			user.bidChange(_timeLeft, itemID);
	}
	...
	public Message getInstance(User user) {
		return new BidStateChangeMessage(user);
	}
...
//
//    public class ASV2014_610 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1455;
//
