...
public class GetTechBackMessage extends Message{

	public static final int id = 1609;
	public int ASV2014_4344;

	public GetTechBackMessage(User user){
		super(user);
	}
	public GetTechBackMessage(User user, int id) {
		this(user);
		ASV2014_4344= id;
	}
	...
	public Message getInstance(User user) {
		return new GetTechBackMessage(user);
	}
...
//
//    public class ASV2014_1482 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1609;
//
