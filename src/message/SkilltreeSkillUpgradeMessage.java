...
public class SkilltreeSkillUpgradeMessage extends Message{

	public static final int id = 1469;
	public int ASV2014_4460;

	public SkilltreeSkillUpgradeMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new SkilltreeSkillUpgradeMessage(user);
	}
...
//
//    public class ASV2014_1479 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1469;
//
