...
public class BonusMapActivateConfirmationMessage extends Message{

	public static final int id = 1172;
	public int bonusMapId;

	public BonusMapActivateConfirmationMessage(User user) {
		super(user);
	}
	...
	public Message getInstance(User user) {
		return new BonusMapActivateConfirmationMessage(user);
	}
...
//
//    public class ASV2014_185 implements ASV2014_30 
//    {
//
//        public static const ASV2014_2337:int = 1172;
//
